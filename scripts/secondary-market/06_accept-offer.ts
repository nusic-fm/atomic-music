...
async function main() {
  ...
  const txt = await masterContract.acceptTokenOffer(addr3.address,addr2.address,ethers.utils.parseEther("0.2"),4);
  console.log("masterContract.acceptTokenOffer txt.hash = ",txt.hash);
